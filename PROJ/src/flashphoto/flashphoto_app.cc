...
// using ConvolutionFilterMotionBlur::BlurDir;
...
FlashPhotoApp::FlashPhotoApp(int width, int height,
    ...
    : GraphicsApp(width, height, "FlashPhoto"),
      ...
      blur_radius_(5.0),
      mblur_radius_(5.0),
      mblur_dir_(ConvolutionFilterMotionBlur::BLUR_DIR_N_S),
      sharpen_radius_(5.0),
      thresh_cutoff_(0.5),
      sat_value_(1.0),
      chan_r_(1.0),
...
void FlashPhotoApp::InitNanoGUI() {
  ...
  new nanogui::Label(window, "FlashPhoto Tools", "sans-bold");
  ...
  /**vvvvvvvvvvvvvvvvvvvvvv CHANGE THIS FOR MBLURDIR **/
  new nanogui::Label(m_blur_params, "Direction:", "sans-bold");
  nanogui::ComboBox *mbr_cb = new nanogui::ComboBox(
      m_blur_params, {ConvolutionFilterMotionBlur::MotionBlurDirectionName(
                                     ConvolutionFilterMotionBlur::BLUR_DIR_N_S),
                      ConvolutionFilterMotionBlur::MotionBlurDirectionName(
  ...
  mbr_cb->setCallback([this](float value) {
    ...
    mblur_dir_ = static_cast<ConvolutionFilterMotionBlur::BlurDir>(intValue);
  });
