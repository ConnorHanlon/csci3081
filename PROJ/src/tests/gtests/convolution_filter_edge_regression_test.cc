...
class ConvolutionFilterEdgeRegressionTest : public ::testing::Test {
  void SetUp() override {}

 protected:
  ConvolutionFilterEdge filter_;
  const std::string file_truth = "PROJ/resources/edge_truth.png";
  const std::string test_input = "PROJ/resources/test-standard.png";
};

TEST_F(ConvolutionFilterEdgeRegressionTest, MatchesTestEdgeImage) {
  ...
  t_editor->ApplyEdgeDetectFilter();
