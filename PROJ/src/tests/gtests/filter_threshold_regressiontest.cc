...
TEST_F(FilterThresholdRegressionTest, MatchesTestFilterThresholdImage) {
  const std::string file_truth = "PROJ/resources/threshold_half_truth.png";
  ...
  t_editor->ApplyThresholdFilter(0.5);
