...
class ToolBlurRegressionTest : public ::testing::Test {
  void SetUp() override {}

 protected:
  ToolBlur blur_;
  const std::string input_file = "./resources/test-standard.png";
  const std::string file_truth = "./resources/tool_blur_truth.png";
};

TEST_F(ToolBlurRegressionTest, MatchesTestToolImage) {
  ...
  t_editor->StartStroke(blur_.name(), ColorData(0.5, 0.5, 0.5), 10.0, 10, 10);
