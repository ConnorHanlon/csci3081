...
class ToolEraserRegressionTest : public ::testing::Test {
  void SetUp() override {}

 protected:
  ToolEraser tool_;
  const std::string input_file = "./resources/test-standard.png";
  const std::string file_truth = "./resources/tool_eraser_truth.png";
};

TEST_F(ToolEraserRegressionTest, MatchesTestToolImage) {
